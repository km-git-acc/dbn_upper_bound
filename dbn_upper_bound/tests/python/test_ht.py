...
class TestHtMethods(unittest.TestCase):
    ...
    def test_ht_afe_abc(self):
        ...
        self.assertEqual(Ht_AFE_ABC(1000000.0, 0.23),
                         mpm.ctx_mp_python.mpf('-2.079117127359716401705367663903184175629392964318676288277755004089816901327445854856268904159123038e-170537')
        
        self.assertEqual(Ht_AFE_ABC(3000000.0, 0.23),
                         mpm.ctx_mp_python.mpf('7.754307373196585578741651057258108684598351023017606312425048617731234941784349947001564214588866919e-511631')
