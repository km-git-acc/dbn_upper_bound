...
{  
    arb_t a, b, c, d, e, n, htot, step, pi, n0d128, n2d30;
    arb_init(a);
    arb_init(b);
    arb_init(c);
    arb_init(d);
    ...
    while (m < samp)
    {
        ...
        printf("| %ld | % 8.3f | % 03.5f | % 8.3f | % 8.3f | \n", a1, b1, c1, d1, e1);
        m = m + 1;
    }
...
slong
z_accuracy(slong preccnt, arb_t xa, slong target, slong prec)
{
    acb_t a, s;
    acb_init(a);
    acb_init(s);
    ...
    acb_dirichlet_hardy_z(s, a, NULL, NULL, 1, prec);
    preccnt = prec; 

    while(arb_rel_accuracy_bits(acb_realref(s)) < target)
    {
        preccnt = preccnt + 1;
        acb_dirichlet_hardy_z(s, a, NULL, NULL, 1, preccnt);
    }
...
TIMEIT_ONCE_START
    ...
    case 1:
     ...
     case 2:
        ...
        printf("\nNumber of non-trivial zeros in the strip <= Gram(%ld)=%f : %ld \n\n", t2a, t2b, t2c);
        break;
     ...
     case 4:
        ...
        prec = z_accuracy(prec, a, 20, 16);

        arb_get_ubound_arf(u, xa, prec);
        slong t4a=arf_get_d(u, ARF_RND_NEAR);
        arb_get_ubound_arf(u, a, prec);
        double t4b=arf_get_d(u, ARF_RND_NEAR);
        printf("\nGram point %ld = %8.9f and is ", t4a, t4b);
     ...
     case 5:
        ...
        arb_get_ubound_arf(u, xa, prec);
        double t5a=arf_get_d(u, ARF_RND_NEAR);
        arb_get_ubound_arf(u, a, prec);
        double t5b=arf_get_d(u, ARF_RND_NEAR);
        printf("\n");
        printf("Z(%f) = %8.10f (10 digits accurate) \n\n", t5a, t5b);
        break;
...
finish:
    ...
    {
        flint_printf("\nRequired inputs:\n");
        flint_printf("%s gp_m mode \n\n", argv[0]);
        flint_printf(
    "This script implements three ways to count zeros of Z(t) in the strip:\n\n"
    "Mode = 1: Turing's method testing S(gp_m) < 2 using Log(gp_m)+10 samples.\n"
    "Mode = 2: N(t)-formula (unreliable at Bad gram points).\n"
    ...
    "Mode = 5: Util 2: Return value of Z(x) at 10 guaranteed digits accuracy.\n\n");
    }
