...
int main(int argc, char *argv[])
{
    ...
    prec = 20 * 3.32192809488736 + 90;

    //*** here are all fixed parameters set ***
    arb_set_str(X, "10000000000000012010", prec);
    taylorterms = 104;
    //*** here are all fixed parameters set ***
...
finish:
	...
	"X = 10^19 + 12010; Taylor expansion = 104 x 104 terms (i.e. 20 digit accuracy).\n"
    "The only input required is a matrix indexnumber from 0 .. 10815 (104 x 104 - 1). \n"
