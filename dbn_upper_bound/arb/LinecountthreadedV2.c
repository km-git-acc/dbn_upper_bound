...
void* isolate_bad_Gram_points(void *voidData)
{
    ...
    slong tmp, blocklength, prevblklen, targetprec, gramquality, prevqual, roots, missingzeros, rossercnt;
       ...
       {    
           ...
           if(missingzeros > 0)
           {
               ...
               if(missingzeros == 0)
               {
                   ...
                   rossercnt++;
                   arb_set(arb_mat_entry(Rosserruleviol, id, rossercnt), arb_mat_entry(currgi, id, 0));
       ...
       if(prevqual== 0 && gramquality)
       {
           ...
           else
           {
                ...
                if(missingzeros == 0)
                {
                   ...
                   rossercnt++;
                   arb_set(arb_mat_entry(Rosserruleviol, id, rossercnt), arb_mat_entry(currgi, id, 1));
    ...
    {    
       ...
       if (arb_is_positive(subcount))
       {
           ...
           switch (j)
           {
              ...
              case 2:
                 printf("next Good to Good int.: %ld (Rosser violation Type 1)\n", tmp); break;
              case 3:
                 printf("previous interval     : %ld (Rosser violation Type 2)\n", tmp); break;
              case 4:
                 printf("next Gramblock        : %ld (Rosser violation Type 3)\n", tmp); break;
              default:
                 break;
           }
           arb_add(totcount, totcount, subcount, prec);
