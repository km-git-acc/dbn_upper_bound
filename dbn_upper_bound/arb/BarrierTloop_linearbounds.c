...

{
    ...
    arb_t pi, ab, bb, harb, Harb, n0, t, modabb, minmodabb, windnum, windtot, dxabb, dtabb,
    ...
    {
    printf("Recalculation of the ddx and ddt bounds for %ld linesegments...\n", linesegs);
    printf("\n");
    }
...
skip:
    ...
    while(arb_lt(t, te))
    {
        ...
        if (arb_ge(t, arb_mat_entry(pntsmat, linecount, 0)))
        {
