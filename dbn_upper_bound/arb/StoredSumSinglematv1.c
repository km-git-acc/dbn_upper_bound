...
void 
storedsums(slong res, const arb_t X, const slong N, slong digits, slong prec)

{
    ...
    slong e, n, t, expterms, taylorterms;
...
int main(int argc, char *argv[])
{
    ...
    storedsums(res, X, N, digits, prec);
