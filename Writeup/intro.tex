...
\begin{figure}[h!]
  ...
  \caption{Comparison of $|f_t(x+iy)|$ and $|H_t(x+iy)|/|B_t(x+iy)|$ for $y=0.9$, $t=0.1$, $1000 \leq x \leq 1030$.}
	\label{htft}
\end{figure}

\begin{figure}[h!]
  \includegraphics[width=0.6\linewidth]{ft_vs_HtdivBt_y_0.png}
  \caption{Comparison of $|f_t(x+iy)|$ and $|H_t(x+iy)|/|B_t(x+iy)|$ for $y=0$, $t=0.3$, $1000 \leq x \leq 1030$.}
	\label{htft-2}
\end{figure}

{\bf would it be possible to also supply a figure for a different range of $x$ to show that the approximation improves as $x$ gets larger?}
