...
De Bruijn \cite{debr} introduced (with somewhat different notation) the more general family of functions $H_t \colon \C \to \C$ for $t \in \R$ by the formula
...
{\bf insert one of Rudolph's graphics to illustrate Theorem \ref{ubc-0} here?}

\begin{figure}[h!]
  \includegraphics[width=0.9\linewidth]{Barrier_approach.png}
  \caption{The Barrier-approach visualised}
\end{figure}
...
{\bf maybe give a table or graph comparing $H_t$ and $B_t$ in various regimes?}

\begin{figure}[h!]
  \includegraphics[width=1.0\linewidth]{Ht_vs_Bt_variousregimes.png}
  \caption{$H_t$ vs $B_t$ in various regimes.}
\end{figure}
...
{\bf A graph or table to illustrate the accuracy of the $f_t$ approximation to $H_t/B_t$ approximation for various choices of parameters.}

\begin{figure}[h!]
  \includegraphics[width=0.6\linewidth]{ft_vs_HtdivBt_y_09.png}
  \caption{Accuracy of the $f_t$ approximation to $H_t/B_t$ approximation $y=0.9, t=0.1$.}
\end{figure}

\begin{figure}[h!]
  \includegraphics[width=0.6\linewidth]{ft_vs_HtdivBt_y_0.png}
  \caption{Accuracy of the $f_t$ approximation to $H_t/B_t$ approximation $y=0, t=0.3$.}
\end{figure}
...
{\bf added a graph to show the effect of the extra Riemann Siegel term}

\begin{figure}[h!]
  \includegraphics[width=0.6\linewidth]{Extra_RS_term.png}
  \caption{A more accurate approximation by adding an extra term to $f_t$.}
\end{figure}
