...
\begin{align*}
A_t(x+iy) &\coloneqq M_t(\frac{1-y+ix}{2}) \sum_{n=1}^N \frac{b_n^t}{n^{\frac{1-y+ix}{2}  +\frac{t}{2} \alpha(\frac{1-y+ix}{2})}}  \\
B_t(x+iy) &\coloneqq M_t(\frac{1+y-ix}{2}) \sum_{n=1}^N \frac{b_n^t}{n^{\frac{1+y-ix}{2} +\frac{t}{2} \alpha(\frac{1+y-ix}{2})}}  \\
