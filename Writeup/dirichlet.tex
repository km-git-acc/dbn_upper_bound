...
For each of the chosen candidates, we can then evaluate $\min(|(A+B)/B0|_{(q-0.5,q,q+0.5)})$ at t=0, and finally select a candidate where this is highest.
...
Among these, q=83952 gives the highest $\min|(A+B)/B0|_{(q-0.5,q,q+0.5)} (\approx 4.32)$.
