...
{\bf describe the numerical output of this algorithm, for instance discussing the values of $t$ used, the size of the mesh at different points in $t$, etc.}
