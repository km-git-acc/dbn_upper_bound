...
$$ |E_{t,5}(x+iy)| \geq \prod_{p \leq 5} \left(1 - \frac{b_p^t}{p^{\mathrm{Re} s_*}} \right) \geq 0.534 $$ %  0.512 when p=7
and the argument has magnitude at most
$$ \sum_{p \leq 5} \sin^{-1} \frac{b_p^t}{p^{\mathrm{Re} s_*}} \leq 0.553. $$ % 0.595 when p=7
...
$$ [69098, 8 \times 10^4], [8 \times 10^4, 1 \times 10^5], [1 \times 10^5, 2 \times 10^5], [2 \times 10^5, 1 \times 10^6], [1 \times 10^6, 1.5 \times 10^6]$$
will suffice (with $F_{N_-, N_+} \geq 0.02$ in all such intervals; for instance, $F_{69098, 8 \times 10^4} = 0.0263\dots$).
