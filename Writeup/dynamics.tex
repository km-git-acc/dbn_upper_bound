...
\begin{align}
\operatorname{He}_m(z) &= (-1)^m \exp(\frac{z^2}{2}) \frac{d^m}{dz^m} \exp(-\frac{z^2}{2})\label{heform}\\
...
\begin{theorem}[Upper bound criterion]\label{ubc}  Suppose that $t_0 > 0, X, y_0 > 0$ obey the following hypotheses:
\begin{itemize}
